...
if (!$errors) {	
	...
	$to = "support@polygod.io"; // Your email goes here	
	$subject = "Request";
	$headers = "From: Polygod <replyto@yourdomain.com>";	
	...
	echo '<a class="animated-link" href="../">Go Back</small>';
	echo '</div>';	
}
